  ...
  template: `
    <section class="page">
      <div class="toolbar-row">
        <div><h1>Notifications</h1><p class="muted">Lookup records from the notifications-service.</p></div>
...
export class NotificationsComponent {
  ...
  load() {
    this.api.get<unknown[]>('notifications', `/notifications/customers/${this.form.controls.id.value}`).subscribe({
